...
@export var Color_Pl_Gp = Color(1.0, 0.54902, 0.4, 1.0)
@export var Color_Lp_B = Color(1.0, 1.0, 0.4, 1.0)
@export var Color_Co_B = Color(0.4, 1.0, 1.0, 1.0)
@export var Color_En_B = Color(0.52157, 0.52157, 0.52157)
@export var Color_En_Os = Color(1.0, 0.4, 0.4)
