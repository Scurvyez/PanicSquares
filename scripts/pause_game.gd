...
func set_initial_ui():
	...
	Keys_Overlay.modulate = Col_Util.Color_Heart
	...
	Keys_Base.position = Vector2(screenSize.x / 2, (screenSize.y / 2) + vert_offset)
	Keys_Overlay.position = Vector2(screenSize.x / 2, (screenSize.y / 2) + vert_offset)
